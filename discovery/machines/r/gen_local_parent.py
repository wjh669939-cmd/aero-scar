...
outcome = dr.run_pipeline(cfg, seed=42, run_id="parent_local_r_seed42",
...
if outcome.status == "success":
    out = Path("/root/autodl-tmp/clh_deploy/discovery/parent_local_r")
    flat, deltas, combined = dr.eval_all_legs(outcome.output_root, "parent-local-r", 42,
